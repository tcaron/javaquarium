...
<html>
	...
	<body class="container">
		<h1><bean:message key="message.inscription.title.headertitle"/></h1>
		<hr />
    <ul class="list-group">
      <html:errors/>
    </ul>
    <html:form styleClass="form-horizontal" action="register">
      <div class="form-group">
		    <label for="login" class="col-sm-3 control-label">
		      <bean:message key="message.inscription.input.name.login"/>
	      </label>
	      <div class="col-sm-5">
	    ...
	    <div class="form-group">
		    <label for="password" class="col-sm-3 control-label">
		      <bean:message key="message.inscription.input.name.password"/>
		    </label>
		    <div class="col-sm-5"> 
	    ...
	    <div class="form-group">
	      <div class="col-sm-offset-3 col-sm-9">
            ...
            <bean:message key="message.inscription.button.name.retouraccueil"/>
          </a>
	      </div>
      </div>
    </html:form>
