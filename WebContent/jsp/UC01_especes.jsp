...
<body class="container">
	...
	<center>
		...
		<bean:message key="message.listerespece.infos"/> (<bean:write name="aquarium_size" scope="session" />)
		<a class="btn btn-success btn-xs" href="/Javaquarium/saveAquarium.do"> <bean:message key="message.listerespeces.sauvegarder" /></a>				
		<a class="btn btn-danger btn-xs" href="/Javaquarium/emptyAquarium.do"><bean:message key="message.listerespeces.vider" /> </a>
